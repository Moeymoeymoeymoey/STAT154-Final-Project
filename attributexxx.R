...
mydata1 = cbind((as.character(business.train$business_id)), mydata)

count_na = function(x) {return(sum(is.na(x)))}
num_na_row = apply(mydata1, MARGIN = 1, count_na)
#summary(num_na_row)
mydata2 = mydata1[num_na_row < 40,]
num_na_col = apply(mydata2, MARGIN = 2, count_na)
#summary(num_na_col)
mydata2 = mydata2[,num_na_col<1734]
...
class(mydata3[,4])
write.csv(mydata3, file = "xxx3.csv")
